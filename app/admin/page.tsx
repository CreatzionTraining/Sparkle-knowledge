...
export default function AdminPage() {
  ...
  if (view === 'list') {
    return (
      <div className="h-screen overflow-y-auto bg-gray-50 flex justify-center font-sans text-gray-900 overflow-x-hidden">
  ...
  return (
    <>
      <div className="h-screen overflow-y-auto bg-gray-50 pb-20 font-sans text-gray-900 overflow-x-hidden">
        {/* Top Navigation Bar */}
