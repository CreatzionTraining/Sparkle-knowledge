...
After this, you can start working on your branch. Please make sure the bottom-left corner shows your branch name as Rubesh before you begin

Once you make any changes or complete any work, use the below commands to push your updates to your branch.

git add .
git commit -m "Your commit message here"
git push -u origin Rubesh    ⚠️ Important: Do not push to the main branch by mistake — always push only to your own branch
...
You do not need to switch to the main branch.
Stay on your own branch (Rubesh) and pull the changes from main directly into your branch.
...
After this, you can start working on your branch. Please make sure the bottom-left corner shows your branch name as Sakthi before you begin
        npm run dev
Once you make any changes or complete any work, use the below commands to push your updates to your branch.

git add .
git commit -m "Your commit message here"
git push -u origin Sakthi    ⚠️ Important: Do not push to the main branch by mistake — always push only to your own branch
...
You do not need to switch to the main branch.
Stay on your own branch (Sakthi) and pull the changes from main directly into your branch.
...
git checkout main
git merge Branch Name ( EX: Sakthi/Rubesh/Bhuvan ) 
npm install
