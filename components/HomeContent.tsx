        ...
        <div className="max-w-[95%] lg:max-w-[1400px] mx-auto px-8 lg:px-12">
          <div className="flex justify-between items-center h-28">
            ...
            <div className="hidden lg:flex items-center">
              <a href="#contact" className="group relative px-6 py-2.5 bg-gradient-to-r from-[#1D4ED8] via-[#E63946] to-[#1D4ED8] bg-[length:200%_auto] animate-text-wave rounded-full text-white font-bold text-sm shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50 hover:scale-105 transition-all duration-300 overflow-hidden">
