...
export default function NewsTicker() {
  ...
  return (
    <>
      <div className="relative w-full bg-linear-to-r from-gray-900 via-slate-900 to-gray-900 text-white h-12 flex items-center z-10 rounded-xl mb-12 shadow-md overflow-hidden">
