          ...
          <div className="lg:col-span-9">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 sm:p-12 space-y-16">
              ...
              <section id="contact" className="space-y-4 scroll-mt-24 pt-8 border-t border-gray-100">
                <h2 className="text-2xl font-bold text-slate-900 flex items-center gap-3">
                  <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-gradient-to-r from-[#1D4ED8] to-[#E63946] text-white text-sm font-bold shadow-md shadow-blue-500/20">06</span>
                  Have Questions?
                </h2>
                <div className="prose prose-slate max-w-none text-slate-600 leading-relaxed">
                  <p>
